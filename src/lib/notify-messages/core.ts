...
export const NOTIFY_SIGN_IN_TO_SAVE_SETTINGS_TO_THE_CLOUD = "Sign in to save settings to the cloud";
export const NOTIFY_CONFIGURE_SUPABASE_ON_THE_API_SERVER_FIR = "Configure Supabase on API server";
