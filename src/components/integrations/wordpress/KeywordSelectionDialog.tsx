...
import { NOTIFY_INVALID_KEYWORD_SELECTED_PLEASE_TRY_AGAI } from "@/lib/notify-messages";
...
export const KeywordSelectionDialog: React.FC<KeywordSelectionDialogProps> = ({
  ...
  try {
    ...
    safeQueries = [...safeQueries].sort((a, b) => {
  ...
  try {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-[950px] bg-card text-foreground max-h-[90vh] !grid !grid-rows-[auto_1fr_auto] !overflow-hidden p-0 gap-0">
                              ...
                              <Button
                                onClick={(e) => {
                                  ...
                                  if (topKeyword && topKeyword.query && typeof topKeyword.query === 'string') {
                                    ...
                                    notify.error(NOTIFY_INVALID_KEYWORD_SELECTED_PLEASE_TRY_AGAI);
                                  }
                                }}
                                className="w-full bg-primary hover:bg-primary/90 text-primary-foreground font-semibold py-6 text-base shadow-lg"
                              >
