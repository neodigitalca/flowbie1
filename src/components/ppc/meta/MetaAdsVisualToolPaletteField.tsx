...
} from "@/components/ppc/meta/MetaAdsColorPaletteField";
import {
...
import type { MetaAdColorPalette, MetaAdVisualToolKey, MetaAdVisualToolPalette } from "@/lib/ppc/meta-ads-types";
import {
...
export type MetaAdsVisualToolPaletteFieldProps = {
...
export function MetaAdsVisualToolPaletteField({
  value,
  colorPalette,
  typographyStyle,
  rowOffset = 0,
  ...
  onTypographyStyleChange,
  onResetToWorkspace,
}: MetaAdsVisualToolPaletteFieldProps) {
