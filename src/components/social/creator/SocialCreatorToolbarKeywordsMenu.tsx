...
} from "@/lib/social/social-creator-keyword-template";
import { cn } from "@/lib/utils";

export type SocialCreatorToolbarKeywordsMenuProps = {
  disabled?: boolean;
  onImportKeywords: (file: File) => void | Promise<void>;
};

export function SocialCreatorToolbarKeywordsMenu({
  disabled = false,
  onImportKeywords,
}: SocialCreatorToolbarKeywordsMenuProps) {
