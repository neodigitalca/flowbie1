...
import { META_VISUAL_CONTROL_SURFACE_CLASS } from "@/components/social/creator/social-creator-visual-settings-layout";
import { cn } from "@/lib/utils";

export type SocialCreatorDarkSelectOption = {
  value: string;
  label: string;
};

export type SocialCreatorDarkSelectProps = {
  value: string;
  options: SocialCreatorDarkSelectOption[];
  disabled?: boolean;
  id?: string;
  className?: string;
...
export function SocialCreatorDarkSelect({
  value,
  options,
  disabled,
  id,
