...
const CONNECTED_BTN_CLASS =
  "inline-flex h-8 shrink-0 items-center justify-center gap-1.5 rounded-none border-0 bg-zinc-900 px-2.5 text-base font-medium text-green-400 shadow-none cursor-default";
