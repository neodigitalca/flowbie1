...
const MANUAL = {
  ...
  NOTIFY_CONFIGURE_SUPABASE_ON_THE_API_SERVER_FIR: "Configure Supabase on API server",
  ...
  NOTIFY_POST_BANK_AND_SAP_BANK_SQL_APPLIED_TRY_C: "Bank SQL applied, create table",
