 ...
 *
 * Usage:
 *   node scripts/embed-wp-supabase-config.mjs
 *   SUPABASE_ANON_KEY=... node scripts/embed-wp-supabase-config.mjs
 *   node scripts/embed-wp-supabase-config.mjs --internal-build
 *   NEO_PULSE_WP_DEFAULT_API_BASE=https://your-api-host node scripts/embed-wp-supabase-config.mjs
 */
