...
( function ( $ ) {
	function templateInputs() {
		return $( '.flowbie-fields-acf-gallery__template-input' );
	}

	function syncSelectAll() {
		var $inputs = templateInputs();
		var $selectAll = $( '.flowbie-fields-acf-gallery__select-all-input' );
	...
	$( function () {
		var $bulkForm = $( '#flowbie-fields-acf-gallery-bulk' );

		$( '.flowbie-fields-acf-gallery__select-all-input' ).on( 'change', function () {
			var checked = $( this ).prop( 'checked' );
			templateInputs().prop( 'checked', checked );
			$( this ).prop( 'indeterminate', false );
		} );

		$( document ).on( 'change', '.flowbie-fields-acf-gallery__template-input', syncSelectAll );
