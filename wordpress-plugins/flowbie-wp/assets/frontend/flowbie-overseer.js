/**
 * Flowbie Overseer — first-party analytics beacon (pageviews, time on page, interactions).
 */
(function () {
	'use strict';

	function readConfig() {
		if (window.flowbieOverseer && window.flowbieOverseer.endpoint && window.flowbieOverseer.nonce) {
			return window.flowbieOverseer;
		}
		var el = document.getElementById('flowbie-overseer-config');
	...
	var STORAGE_KEY = 'flowbie_overseer_session';
	var VISIT_UID_PREFIX = 'flowbie_overseer_visit:';
