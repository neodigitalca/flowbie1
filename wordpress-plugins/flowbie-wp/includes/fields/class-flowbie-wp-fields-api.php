...
class Flowbie_Wp_Fields_Api {
	...
	public static function register_functions(): void {
		...
		if ( ! function_exists( 'get_field' ) ) {
			...
			function get_field( $selector, $post_id = false, $format_value = true ) {
				return Flowbie_Wp_Fields_Api::get_field( $selector, $post_id, $format_value );
			}
		}
		if ( ! function_exists( 'the_field' ) ) {
			function the_field( $selector, $post_id = false, $format_value = true ): void {
				Flowbie_Wp_Fields_Api::the_field( $selector, $post_id, $format_value );
			}
		}
		if ( ! function_exists( 'get_fields' ) ) {
			function get_fields( $post_id = false, $format_value = true ) {
				return Flowbie_Wp_Fields_Api::get_fields( $post_id, $format_value );
			}
		}
		if ( ! function_exists( 'get_field_object' ) ) {
			function get_field_object( $selector, $post_id = false, $format_value = true, $load_value = true ) {
				return Flowbie_Wp_Fields_Api::get_field_object( $selector, $post_id, $format_value, $load_value );
			}
		}
		if ( ! function_exists( 'update_field' ) ) {
			function update_field( $selector, $value, $post_id = false ) {
				return Flowbie_Wp_Fields_Api::update_field( $selector, $value, $post_id );
			}
		}
		if ( ! function_exists( 'delete_field' ) ) {
			function delete_field( $selector, $post_id = false ) {
				return Flowbie_Wp_Fields_Api::delete_field( $selector, $post_id );
			}
		}
		if ( ! function_exists( 'have_rows' ) ) {
			function have_rows( $selector, $post_id = false ) {
				return Flowbie_Wp_Fields_Api::have_rows( $selector, $post_id );
			}
		}
		if ( ! function_exists( 'the_row' ) ) {
			function the_row( $format = false ) {
				Flowbie_Wp_Fields_Api::the_row( $format );
			}
		}
		if ( ! function_exists( 'get_row' ) ) {
			function get_row( $format = false ) {
				return Flowbie_Wp_Fields_Api::get_row( $format );
			}
		}
		if ( ! function_exists( 'get_sub_field' ) ) {
			function get_sub_field( $selector, $format_value = true ) {
				return Flowbie_Wp_Fields_Api::get_sub_field( $selector, $format_value );
			}
		}
		if ( ! function_exists( 'update_sub_field' ) ) {
			function update_sub_field( $selector, $value, $post_id = false ) {
				return Flowbie_Wp_Fields_Api::update_sub_field( $selector, $value, $post_id );
			}
		}
		if ( ! function_exists( 'acf_add_local_field_group' ) ) {
			function acf_add_local_field_group( $group ) {
				return Flowbie_Wp_Fields_Api::add_local_field_group( $group );
			}
		}
		if ( ! function_exists( 'acf_add_options_page' ) ) {
			function acf_add_options_page( $page ) {
				return Flowbie_Wp_Fields_Api::add_options_page( $page );
			}
		}
	}
	...
	public static function add_local_field_group( array $group ): bool {
		...
		Flowbie_Wp_Fields_Storage::flush_cache();
		return true;
	}
	...
	public static function add_options_page( array $page ): bool {
		return Flowbie_Wp_Fields_Options::register_page( $page );
	}
	...
	public static function get_field( $selector, $post_id = false, $format_value = true ) {
		...
		if ( $is_option ) {
			return Flowbie_Wp_Fields_Values::get_option( $id, $field, $format_value );
		}
		return Flowbie_Wp_Fields_Values::get_value( $id, $field, $format_value );
	}
	...
	public static function get_fields( $post_id = false, $format_value = true ): array {
		list( $id, $is_option ) = self::normalize_post_id( $post_id );
		$screen = $is_option ? array( 'options_page' => $id ) : Flowbie_Wp_Fields_Values::screen_for_post( $id );
		$out    = array();
		foreach ( self::all_groups() as $group ) {
			...
			foreach ( isset( $group['fields'] ) ? $group['fields'] : array() as $field ) {
				...
				if ( $is_option ) {
					$out[ $name ] = Flowbie_Wp_Fields_Values::get_option( $id, $field, $format_value );
				} else {
					$out[ $name ] = Flowbie_Wp_Fields_Values::get_value( $id, $field, $format_value );
				}
			}
		}
		return $out;
	...
	public static function get_field_object( $selector, $post_id = false, $format_value = true, $load_value = true ) {
		...
		if ( $load_value ) {
			list( $id, $is_option ) = self::normalize_post_id( $post_id );
			if ( $is_option ) {
				$field['value'] = Flowbie_Wp_Fields_Values::get_option( $id, $field, $format_value );
			} else {
				$field['value'] = Flowbie_Wp_Fields_Values::get_value( $id, $field, $format_value );
			}
		}
		return $field;
	}
	...
	public static function update_field( $selector, $value, $post_id = false ): bool {
		...
		list( $id, $is_option ) = self::normalize_post_id( $post_id );
		if ( $is_option ) {
			Flowbie_Wp_Fields_Values::update_option( $id, $field, $value );
			return true;
		}
		return Flowbie_Wp_Fields_Values::update_value( $id, $field, $value );
	}
	...
	public static function delete_field( $selector, $post_id = false ): bool {
		...
		Flowbie_Wp_Fields_Values::delete_value( $id, $field );
		return true;
	}
	...
	public static function get_sub_field( $selector, $format_value = true ) {
		...
		$field = Flowbie_Wp_Fields_Values::find_field( (string) $selector );
		if ( $field && $format_value ) {
			return Flowbie_Wp_Fields_Registry::format_value( $value, $field, 0 );
		}
		return $value;
	}
	...
	private static function resolve_field( string $selector, $post_id ) {
		...
		return Flowbie_Wp_Fields_Values::find_field( $selector, $context_id );
	}
