<?php
/**
 * Register Flowbie field keys with register_post_meta for REST / Elementor discovery.
 *
 * @package Flowbie_Wp
 */
...
class Flowbie_Wp_Fields_Post_Meta_Registry {
	...
	public static function meta_label_for_field( string $name, array $field ): string {
		...
		return sprintf( 'Flowbie_%s — %s', $name, $label );
	}
}
