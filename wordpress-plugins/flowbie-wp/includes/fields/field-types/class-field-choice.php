...
class Flowbie_Wp_Field_Type_Select extends Flowbie_Wp_Field_Type_Base {
...
class Flowbie_Wp_Field_Type_Checkbox extends Flowbie_Wp_Field_Type_Base {
	...
	public function render_input( array $field, $value, int $post_id ): void {
		...
		echo '<ul class="flowbie-checkbox-list">';
		foreach ( $choices as $k => $label ) {
			printf(
...
class Flowbie_Wp_Field_Type_Radio extends Flowbie_Wp_Field_Type_Base {
	...
	public function label(): string {
		return __( 'Radio Button', 'flowbie-wp' );
	}
	...
	public function render_input( array $field, $value, int $post_id ): void {
		...
		$this->wrap_open( $field );
		$choices = isset( $field['choices'] ) && is_array( $field['choices'] ) ? $field['choices'] : array();
		echo '<ul class="flowbie-radio-list">';
		foreach ( $choices as $k => $label ) {
			printf(
...
class Flowbie_Wp_Field_Type_True_False extends Flowbie_Wp_Field_Type_Base {
	...
	public function label(): string {
		return __( 'True / False', 'flowbie-wp' );
	}
