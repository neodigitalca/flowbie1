...
/**
 * Manages flowbie_wp_speed_settings option.
 */
class Flowbie_Wp_Speed_Settings {

	const OPTION_KEY = 'flowbie_wp_speed_settings';

	const ELEMENTOR_SAFE_MIGRATION_KEY = 'flowbie_wp_speed_elementor_safe_defaults';

	const ELEMENTOR_SAFE_MIGRATION_V2_KEY = 'flowbie_wp_speed_elementor_safe_defaults_v2';

	const SIMPLE_ENABLED_REPAIR_KEY = 'flowbie_wp_speed_simple_enabled_repair_v1';

	const SIMPLE_ENABLED_REPAIR_V2_KEY = 'flowbie_wp_speed_simple_enabled_repair_v2';

	const SIMPLE_ENABLED_REPAIR_V3_KEY = 'flowbie_wp_speed_simple_enabled_repair_v3';

	const DEFAULT_ON_MIGRATION_KEY = 'flowbie_wp_speed_default_on_v4';
	...
	public static function maybe_repair_simple_enabled_config(): void {
		...
		if ( class_exists( 'Flowbie_Wp_Speed_Gate', false ) && Flowbie_Wp_Speed_Gate::config_has_active_transforms( $config ) ) {
			update_option( self::SIMPLE_ENABLED_REPAIR_KEY, '1', false );
			return;
		}
