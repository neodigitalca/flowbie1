...
class Flowbie_Wp_Speed_Export {
	...
	public static function collect(): array {
		return array(
			'meta'         => self::meta(),
			'speed'        => Flowbie_Wp_Speed_Settings::get_config(),
			'speed_images' => Flowbie_Wp_Speed_Image_Settings::get_config(),
	...
	public static function download_filename(): string {
		...
		return 'flowbie-speed-settings-' . $host . '-' . gmdate( 'Y-m-d' ) . '.json';
	}
	...
	private static function meta(): array {
		$meta = array(
			'plugin_version' => defined( 'FLOWBIE_WP_VERSION' ) ? FLOWBIE_WP_VERSION : '',
			'site_url'       => home_url( '/' ),
