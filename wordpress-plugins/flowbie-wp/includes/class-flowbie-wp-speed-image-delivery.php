 ...
 */
class Flowbie_Wp_Speed_Image_Delivery {
	...
	public static function best_url_for_attachment( int $attachment_id, string $size_key = 'full' ): ?string {
		if ( ! self::should_serve_webp() && ! Flowbie_Wp_Speed_Image_Settings::is_enabled() ) {
			return null;
		}

		$meta = Flowbie_Wp_Speed_Image_Optimizer::get_meta( $attachment_id );
