 ...
 */
class Flowbie_Wp_Speed_Excludes {

	/**
	 * Built-in Flowbie script handles/URL needles (chat, voice).
	 *
	...
	public static function default_js_needles(): array {
		 ...
		 */
		return apply_filters( 'flowbie_wp_speed_default_js_excludes', $defaults );
	}
	...
	public static function default_css_needles(): array {
		 ...
		 * @param array<int, string> $defaults Needles matched against lowercase asset URLs.
		 */
		return apply_filters( 'flowbie_wp_speed_default_css_excludes', $defaults );
	}
	...
	public static function is_excluded( string $url, string $type, array $config ): bool {
		...
		$user    = Flowbie_Wp_Speed_Settings::parse_exclude_lines( (string) ( $config[ $key ] ?? '' ) );
		...
		return (bool) apply_filters( 'flowbie_wp_speed_is_excluded', false, $url, $type, $config );
	}
	...
	public static function default_defer_js_needles(): array {
		 ...
		 * @param array<int, string> $defaults Needles matched against lowercase asset URLs.
		 */
		return apply_filters( 'flowbie_wp_speed_default_defer_js_excludes', $defaults );
	}
	...
	public static function is_defer_excluded( string $url, array $config ): bool {
		...
		return (bool) apply_filters( 'flowbie_wp_speed_is_defer_excluded', false, $url, $config );
	}
}
