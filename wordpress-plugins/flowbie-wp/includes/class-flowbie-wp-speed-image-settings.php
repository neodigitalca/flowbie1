...
/**
 * Manages flowbie_wp_speed_image_settings option.
 */
class Flowbie_Wp_Speed_Image_Settings {

	const OPTION_KEY = 'flowbie_wp_speed_image_settings';

	const META_KEY = '_flowbie_speed_img';

	const VERSION_META = '_flowbie_speed_img_version';
