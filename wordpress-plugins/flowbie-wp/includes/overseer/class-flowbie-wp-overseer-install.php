...
class Flowbie_Wp_Overseer_Install {

	public static function maybe_install(): void {
		if ( get_option( Flowbie_Wp_Overseer_Context::DB_VERSION_OPTION, '' ) !== Flowbie_Wp_Overseer_Context::TABLE_VERSION ) {
			self::install();
		}
	}
	public static function install(): void {
		...
		$reports = Flowbie_Wp_Overseer_Context::reports_table_name();
		...
		$tasks = Flowbie_Wp_Overseer_Context::tasks_table_name();
		...
		dbDelta( $sql_reports );
		dbDelta( $sql_tasks );
		update_option( Flowbie_Wp_Overseer_Context::DB_VERSION_OPTION, Flowbie_Wp_Overseer_Context::TABLE_VERSION, false );

		if ( get_option( Flowbie_Wp_Overseer_Context::OPTION_KEY, null ) === null ) {
			add_option(
