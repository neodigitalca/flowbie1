...
class Flowbie_Wp_Overseer_Settings {

	public static function get_settings(): array {
		$raw = get_option( Flowbie_Wp_Overseer_Context::OPTION_KEY, array() );
		if ( ! is_array( $raw ) ) {
			$raw = array();
		}
	...
	public static function should_load_beacon_on_frontend(): bool {
		...
		$builtin_id = Flowbie_Wp_Overseer_Beacon::get_builtin_script_id();
		if ( $builtin_id < 1 ) {
			return false;
		}
