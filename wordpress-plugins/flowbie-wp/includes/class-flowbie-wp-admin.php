...
$flowbie_wp_admin_dir = __DIR__ . '/admin/';
require_once $flowbie_wp_admin_dir . 'trait-admin-flash-redirect.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-panel-shell.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-handlers-settings.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-handlers-analytics.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-wp-shell.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-brand-icon.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-wp-admin-bar.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-progress-strip.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-property-grid.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-app.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-handlers-sitemap.php';
...
require_once $flowbie_wp_admin_dir . 'trait-admin-handlers-speed-images.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-speed.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-handlers-image-seo.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-sitemap.php';
...
require_once $flowbie_wp_admin_dir . 'trait-admin-render-settings-placeholder.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-analytics.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-handlers-search.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-ai-widget-design.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-search.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-chat.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-backend-assist.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-super-migrate.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-handlers-super-migrate.php';
require_once $flowbie_wp_admin_dir . 'trait-admin-render-tool-library.php';
require_once FLOWBIE_WP_PLUGIN_DIR . 'includes/fields/admin/trait-admin-fields-shell.php';
require_once FLOWBIE_WP_PLUGIN_DIR . 'includes/fields/admin/trait-admin-fields-render-post-type.php';
require_once FLOWBIE_WP_PLUGIN_DIR . 'includes/fields/admin/trait-admin-fields-render.php';
require_once FLOWBIE_WP_PLUGIN_DIR . 'includes/fields/admin/trait-admin-fields-handlers.php';
require_once FLOWBIE_WP_PLUGIN_DIR . 'includes/fields/admin/trait-admin-tags-shell.php';
require_once FLOWBIE_WP_PLUGIN_DIR . 'includes/fields/admin/trait-admin-tags-render.php';
require_once FLOWBIE_WP_PLUGIN_DIR . 'includes/forms/admin/trait-admin-forms-render.php';
...
class Flowbie_Wp_Admin {
	...
	const ACTION_SAVE_COMMENTS = 'flowbie_wp_save_comments';

	use Flowbie_Wp_Admin_Trait_Flash_Redirect;
	use Flowbie_Wp_Admin_Trait_Render_Panel_Shell;
	use Flowbie_Wp_Admin_Trait_Handlers_Settings;
	use Flowbie_Wp_Admin_Trait_Handlers_Analytics;
	use Flowbie_Wp_Admin_Trait_Handlers_Sitemap;
	...
	use Flowbie_Wp_Admin_Trait_Handlers_Speed_Images;
	use Flowbie_Wp_Admin_Trait_Handlers_Image_Seo;
	use Flowbie_Wp_Admin_Trait_Wp_Shell;
	use Flowbie_Wp_Admin_Trait_Brand_Icon;
	use Flowbie_Wp_Admin_Trait_Wp_Admin_Bar;
	use Flowbie_Wp_Admin_Trait_Render_Progress_Strip;
	use Flowbie_Wp_Admin_Trait_Render_Property_Grid;
	use Flowbie_Wp_Admin_Trait_Render_App;
	use Flowbie_Wp_Admin_Trait_Render_Settings_Placeholder;
	use Flowbie_Wp_Admin_Trait_Render_Analytics;
	use Flowbie_Wp_Admin_Trait_Render_Sitemap;
	...
	use Flowbie_Wp_Admin_Trait_Render_Image_Seo;
	use Flowbie_Wp_Admin_Trait_Handlers_Search;
	use Flowbie_Wp_Admin_Trait_Render_Ai_Widget_Design;
	use Flowbie_Wp_Admin_Trait_Render_Search;
	use Flowbie_Wp_Admin_Trait_Render_Chat;
	use Flowbie_Wp_Admin_Trait_Render_Backend_Assist;
	use Flowbie_Wp_Admin_Trait_Render_Super_Migrate;
	use Flowbie_Wp_Admin_Trait_Handlers_Super_Migrate;
	use Flowbie_Wp_Admin_Trait_Render_Tool_Library;
	use Flowbie_Wp_Admin_Trait_Fields_Shell;
	use Flowbie_Wp_Admin_Trait_Fields_Render_Post_Type;
	use Flowbie_Wp_Admin_Trait_Fields_Render;
	use Flowbie_Wp_Admin_Trait_Fields_Handlers;
	use Flowbie_Wp_Admin_Trait_Tags_Shell;
	use Flowbie_Wp_Admin_Trait_Tags_Render;
	use Flowbie_Wp_Admin_Trait_Forms_Render;
	...
	public static function plugin_action_links( array $links ): array {
		...
		array_unshift(
			$links,
			'<a href="' . esc_url( $url ) . '">' . esc_html__( 'Settings', 'flowbie-wp' ) . '</a>'
		);
		return $links;
	}
	...
	public static function maybe_migrate_notice_user_meta(): void {
		...
		$legacy = 'flowbie_current_notice_dismissed';
	...
	public static function init(): void {
		add_filter( 'plugin_action_links_' . plugin_basename( FLOWBIE_WP_PLUGIN_FILE ), array( __CLASS__, 'plugin_action_links' ) );
		Flowbie_Wp_Admin_Menu::init();
		...
		add_action( 'admin_post_flowbie_wp_save_gmb', array( __CLASS__, 'handle_save_gmb' ) );
		add_action( 'admin_post_flowbie_wp_save_chat', array( __CLASS__, 'handle_save_chat' ) );
		add_action( 'admin_post_flowbie_wp_save_chat_design', array( __CLASS__, 'handle_save_chat_design' ) );
		add_action( 'admin_post_flowbie_wp_save_chat_training', array( __CLASS__, 'handle_save_chat_training' ) );
		add_action( 'admin_post_flowbie_wp_save_chat_knowledge_base', array( __CLASS__, 'handle_save_chat_knowledge_base' ) );
		...
		add_action( 'admin_post_' . self::ACTION_EXPORT_FLO_SHEET, array( __CLASS__, 'handle_export_flo_sheet' ) );
		add_action( 'admin_post_' . self::ACTION_IMPORT_FLO_SHEET, array( __CLASS__, 'handle_import_flo_sheet' ) );
