<?php
/**
 * Elementor widget integration for Flowbie FAQ.
 *
 * @package Flowbie_Wp
 */
...
class Flowbie_Wp_Faq_Elementor {
	...
	public static function register_widgets( $widgets_manager ): void {
		require_once FLOWBIE_WP_PLUGIN_DIR . 'includes/faq/integrations/class-flowbie-wp-faq-elementor-widget.php';
		$widgets_manager->register( new Flowbie_Wp_Faq_Elementor_Widget() );
	}
