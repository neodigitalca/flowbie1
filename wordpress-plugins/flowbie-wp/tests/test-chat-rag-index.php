...
$filtered = Flowbie_Wp_Chat_Rag::filter_index( $sample_index, $settings_post_page );
...
$filtered_cats = Flowbie_Wp_Chat_Rag::filter_index( $sample_index, $settings_exclude_cat );
...
$link_filtered = Flowbie_Wp_Chat_Links::filter_links_to_index( $mixed_links, $filtered );
...
$blog_link_filtered = Flowbie_Wp_Chat_Links::filter_links_to_index( $blog_links, $filtered, $extra_post );
...
set_transient( 'flowbie_chat_context_cache_v4', $raw_for_blog, 3600 );

$blog_posts = Flowbie_Wp_Chat_Rag::collect_sitemap_blog_posts(
...
$blog_card = Flowbie_Wp_Chat_Rag::build_blog_discovery_card(
	'what blogs should i start with',
	$blog_posts,
	array(
		'indexed_post_types'  => array( 'post', 'page' ),
