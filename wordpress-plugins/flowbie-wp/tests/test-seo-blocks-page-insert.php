...
$settings = Flowbie_Wp_Seo_Blocks_Page_Insert::registry_widget_settings( $row );
...
assert( ( $widget['widgetType'] ?? '' ) === 'flowbie_seo_section', 'widget type is flowbie_seo_section' );
