...
$preset_path = Flowbie_Wp_Speed_Import::preset_file_path( Flowbie_Wp_Speed_Import::PRESET_ELEMENTOR_SAFE );
assert_true( is_readable( $preset_path ), 'elementor-safe preset file exists' );

$preset = Flowbie_Wp_Speed_Import::load_preset( Flowbie_Wp_Speed_Import::PRESET_ELEMENTOR_SAFE );
...
$parsed = Flowbie_Wp_Speed_Import::parse_json( file_get_contents( $preset_path ) );
