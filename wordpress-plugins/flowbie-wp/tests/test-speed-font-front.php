...
$out = Flowbie_Wp_Speed_Minify::ensure_font_display_swap( $css );
assert_true( stripos( $out, 'font-display:swap' ) !== false, 'injects font-display swap into @font-face' );

$url = 'https://fonts.googleapis.com/css2?family=Roboto';
$swap = Flowbie_Wp_Speed_Front::url_with_display_swap( $url );
...
$processed = Flowbie_Wp_Speed_Front::process( $html, $config );
