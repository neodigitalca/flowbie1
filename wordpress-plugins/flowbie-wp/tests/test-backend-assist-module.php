...
if ( ! class_exists( 'Flowbie_Wp_Ai_Context', false ) ) {
...
require_once $ba_dir . 'class-flowbie-wp-backend-assist-pipeline-content-prep.php';
require_once $ba_dir . 'class-flowbie-wp-backend-assist-body-ops.php';
require_once FLOWBIE_WP_PLUGIN_DIR . 'includes/class-flowbie-wp-ai-seo-limits.php';
require_once $ba_dir . 'class-flowbie-wp-backend-assist-subagent-aiseo.php';
require_once $ba_dir . 'class-flowbie-wp-backend-assist-subagent-wysiwyg.php';
require_once $ba_dir . 'class-flowbie-wp-backend-assist-subagent-registry.php';
require_once $ba_dir . 'class-flowbie-wp-backend-assist-meta-compound.php';
require_once $ba_dir . 'class-flowbie-wp-backend-assist-pipeline-phases.php';
require_once $ba_dir . 'class-flowbie-wp-backend-assist-build-harness.php';
require_once $ba_dir . 'class-flowbie-wp-backend-assist-plan-preview.php';
...
$sanitized = Flowbie_Wp_Backend_Assist_Plan_Preview::sanitize_params_for_preview(
	array(
		'post_id'         => 19903,
...
$plan_body = Flowbie_Wp_Backend_Assist_Plan_Preview::format_template(
...
$fallback_body = Flowbie_Wp_Backend_Assist_Plan_Preview::format_template(
	'change the intro h2',
	array(
		'goal'             => '',
		'plan_description' => '',
...
ba_assert(
	[] === Flowbie_Wp_Backend_Assist_Cards::links_for_post( 0 ),
	'links_for_post returns empty for invalid post id'
);

$stamped_plan = Flowbie_Wp_Backend_Assist_Cards::enrich_plan_card(
	array(
		'type'           => 'plan',
...
ba_assert(
	! Flowbie_Wp_Backend_Assist_Pipeline_Content_Prep::should_use_body_ops( 'can you rewrite the blog', 19903, array() ),
	'rewrite the blog uses full replace path not body ops'
);
ba_assert(
	Flowbie_Wp_Backend_Assist_Pipeline_Content_Prep::message_requests_full_body_rewrite( 'can you rewrite the blog' ),
...
$constraints = Flowbie_Wp_Backend_Assist_Pipeline_Content_Prep::extract_meta_copy_constraints( $sample_message );
ba_assert(
...
ba_assert(
	Flowbie_Wp_Backend_Assist_Pipeline_Content_Prep::meta_copy_meets_constraints(
...
$action = Flowbie_Wp_Backend_Assist_Cards::action_card(
	array(
		'success' => true,
		'post_id' => 19903,
...
$wrapped = Flowbie_Wp_Backend_Assist_Build_Harness::wrap_card(
	array(
		'type'          => 'action',
...
$faq_wrapped = Flowbie_Wp_Backend_Assist_Build_Harness::wrap_card(
	array(
		'type'          => 'action',
...
ba_assert(
	'rewrite-the-faq-schema' === Flowbie_Wp_Backend_Assist_Build_Harness::message_slug_for_filename( 'rewrite the faq schema' ),
	'message_slug_for_filename slugifies request text'
);

$unstamped = Flowbie_Wp_Backend_Assist_Build_Harness::wrap_card(
	array(
		'type'          => 'action',
		'title'         => 'SEO meta updated',
		'action_result' => array(
...
$faq_no_values = Flowbie_Wp_Backend_Assist_Build_Harness::wrap_card(
	array(
		'type'          => 'action',
		'action_result' => array(
			'build_executed' => true,
...
ba_assert(
	Flowbie_Wp_Backend_Assist_Meta_Compound::message_requests_meta_compound( 'rewrite meta and title' ),
	'message_requests_meta_compound detects meta refresh rewrite'
);
ba_assert(
	! Flowbie_Wp_Backend_Assist_Meta_Compound::message_requests_meta_compound( 'add focus keyword for acf' ),
	'message_requests_meta_compound skips focus keyword only'
);

$meta_plan_params = Flowbie_Wp_Backend_Assist_Pipeline_Content_Prep::resolve_plan_action_params(
...
$resolved_meta_agents = Flowbie_Wp_Backend_Assist_Subagent_Registry::resolve_agents_for_message( 'rewrite meta and title', 19903 );
ba_assert(
...
$resolved_kw_agents = Flowbie_Wp_Backend_Assist_Subagent_Registry::resolve_agents_for_message( 'add focus keyword for acf', 19903 );
ba_assert(
	$resolved_kw_agents === array( 'focus_keyword' ),
	'resolve_agents_for_message maps focus keyword only request'
);

$ctx = Flowbie_Wp_Backend_Assist_Subagent_Aiseo::build_context( 19903 );
$ctx['post_title'] = '10 Window Covering Ideas to Transform Your Home';
$paraphrase_reject = Flowbie_Wp_Backend_Assist_Subagent_Aiseo::validate_seo_title(
	19903,
...
$meta_prep_steps = Flowbie_Wp_Backend_Assist_Build_Harness::harness_prep_steps(
	'rewrite meta and title',
...
Flowbie_Wp_Backend_Assist_Context::$tool_registry['save_post_meta'] = array(
...
Flowbie_Wp_Backend_Assist_Meta_Compound::$test_subagent_outputs = array(
...
$meta_compound_card = Flowbie_Wp_Backend_Assist_Meta_Compound::run(
	'rewrite meta and title',
	array(),
	array( 'post_id' => 19903 )
);
Flowbie_Wp_Backend_Assist_Meta_Compound::$test_subagent_outputs = null;
...
$meta_wrapped = Flowbie_Wp_Backend_Assist_Build_Harness::wrap_card(
	array(
		'type'          => 'action',
...
Flowbie_Wp_Backend_Assist_Context::$builder_context = array(
	'target_scope'  => 'site',
	'frontend_page' => array(
		'post_id' => 99,
...
ba_assert(
	0 === Flowbie_Wp_Backend_Assist_Pipeline_Content_Prep::resolve_effective_post_id( array() ),
	'resolve_effective_post_id returns 0 in site scope without explicit post_id'
);
ba_assert(
	99 === Flowbie_Wp_Backend_Assist_Pipeline_Content_Prep::resolve_effective_post_id( array( 'post_id' => 99 ) ),
