<?php
/**
 * Automation action block catalog (blocks/actions/*.json).
 *
...
class Neo_Pulse_App_Automation_Action_Registry {

	/** @var array<string,array<string,mixed>>|null */
	private static $blocks = null;

	public static function blocks_dir(): string {
		return NEO_PULSE_APP_PLUGIN_DIR . 'includes/automation-recipes/blocks/actions';
	}
