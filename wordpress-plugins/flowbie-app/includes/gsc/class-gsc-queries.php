...
class Flowbie_App_Gsc_Queries {
	...
	public static function fetch_queries( array $body ): array {
		...
		$date_validation = Flowbie_App_Gsc_Service_Account::validate_dates( $start_date, $end_date );
		...
		foreach ( $candidates as $property ) {
			$result = Flowbie_App_Gsc_Service_Account::search_analytics_query(
				$property,
				array(
					'startDate'  => $start_str,
					'endDate'    => $end_str,
