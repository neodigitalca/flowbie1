...
class Flowbie_App_Vertical_Benchmark_Client_Tag {
	...
	public static function resolve_taxonomy( string $taxonomy_id ): array {
		$id = Flowbie_App_Vertical_Benchmark_Taxonomy::normalize( $taxonomy_id );
		return array(
			'clientTag'      => $id,
			'clientTagLabel' => Flowbie_App_Vertical_Benchmark_Taxonomy::label( $id ),
			'source'         => 'taxonomy',
		);
	}
