...
class Flowbie_App_Gmb_Oauth {
	...
	public static function save_config( array $body ): array {
		...
		$existing = Flowbie_App_Json_File_Store::read( Flowbie_App_Data_Paths::gmb_oauth_config_path() );
	...
	public static function handle_callback( array $query ): void {
		...
		Flowbie_App_Gmb_Tokens::save_tokens(
			array(
	...
	public static function test_connection(): array {
		...
		$access_token = Flowbie_App_Gmb_Tokens::get_valid_access_token();
	...
	private static function load_config(): array {
		...
		$file = Flowbie_App_Json_File_Store::read( Flowbie_App_Data_Paths::gmb_oauth_config_path() );
		if ( is_array( $file ) ) {
	...
	private static function write_config( array $payload ): bool {
		$written = Flowbie_App_Json_File_Store::write( Flowbie_App_Data_Paths::gmb_oauth_config_path(), $payload );
		if ( $written ) {
			self::reload_config();
		}
		return $written;
