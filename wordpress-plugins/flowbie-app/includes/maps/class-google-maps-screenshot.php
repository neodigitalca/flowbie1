...
class Flowbie_App_Google_Maps_Screenshot {
	...
	private static function script_path(): string {
		return FLOWBIE_APP_PLUGIN_DIR . 'maps/google_maps_screenshot.py';
	}

	private static function python_command(): string {
		if ( defined( 'FLOWBIE_APP_GOOGLE_MAPS_PYTHON' ) && FLOWBIE_APP_GOOGLE_MAPS_PYTHON !== '' ) {
			return (string) FLOWBIE_APP_GOOGLE_MAPS_PYTHON;
		}
