<?php
/**
 * Knowledge model job progress (JSON files in uploads/flowbie-data).
 *
 * @package Flowbie_App
 */
...
class Flowbie_App_Knowledge_Model_Progress {
	...
	public static function get( string $job_id ) {
		$path = Flowbie_App_Data_Paths::knowledge_model_job_path( $job_id );
		return Flowbie_App_Json_File_Store::read( $path );
	}

	/** @param array<string,mixed> $data */
	private static function write( string $job_id, array $data ): void {
		Flowbie_App_Json_File_Store::write( Flowbie_App_Data_Paths::knowledge_model_job_path( $job_id ), $data );
	}
}
