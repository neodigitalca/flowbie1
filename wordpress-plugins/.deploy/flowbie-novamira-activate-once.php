<?php
/**
 * One-time flowbie.ca Novamira + Elementor activate. Self-deletes after a successful run.
 */
if ( ( $_GET['key'] ?? '' ) !== 'FLOWBIE_NOVAMIRA_TOKEN' ) {
...
$zip_path      = $plugins_dir . '/novamira-1.12.2.zip';
...
$mcp    = isset( $routes['/mcp/novamira'] ) || isset( $routes['/wp/v2'] );
