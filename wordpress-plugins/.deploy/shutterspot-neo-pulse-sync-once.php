<?php
/**
 * One-time Shutter Spot sync: activate NEO Pulse WP, untrained chat, admins only, Chekkit off.
 * Self-deletes after a successful run.
 */
if ( ( $_GET['key'] ?? '' ) !== 'SHUTTER_SYNC_TOKEN' ) {
...
delete_transient( 'neo_pulse_chat_context_cache_v4' );
delete_transient( 'flowbie_chat_context_cache_v4' );
delete_transient( 'neo_pulse_chat_starters_v1' );
