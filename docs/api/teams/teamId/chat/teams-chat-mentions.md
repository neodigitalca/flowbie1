---
title: "Mentions"
slug: teams/teamId/chat/mentions
section: Teams
method: GET
...
Reads mentions from the Teams API. Requires a signed-in team member with communication permissions.
...
```javascript
const res = await fetch(`/api/teams/{teamId}/chat/mentions`, {
  method: "GET",
  credentials: "include",
