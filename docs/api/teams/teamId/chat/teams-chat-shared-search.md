---
title: "Shared Search"
slug: teams/teamId/chat/shared-search
section: Teams
method: GET
...
Reads shared search from the Teams API. Requires a signed-in team member with communication permissions.
...
```javascript
const res = await fetch(`/api/teams/{teamId}/chat/shared-search`, {
  method: "GET",
  credentials: "include",
